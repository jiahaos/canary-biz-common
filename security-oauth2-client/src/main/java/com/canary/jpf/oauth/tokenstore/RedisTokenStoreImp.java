...
public class RedisTokenStoreImp implements TokenStore {
    ...
    private static String REFRESH_AUTH = "refresh_auth:";
    private static String ACCESS_TO_REFRESH = "access_to_refresh:";
    private static String REFRESH = "refresh:";
    private static String REFRESH_TO_ACCESS = "refresh_to_access:";
    private static String CLIENT_ID_TO_ACCESS = "client_id_to_access:";
    private static String UNAME_TO_ACCESS = "uname_to_access:";
    ...
    private static void setNameSpace(String nameSpace) {
        ACCESS = nameSpace + "_" + ACCESS;
        AUTH_TO_ACCESS = nameSpace + "_" + AUTH_TO_ACCESS;
        AUTH = nameSpace + "_" + AUTH;
        REFRESH_AUTH = nameSpace + "_" + REFRESH_AUTH;
        ACCESS_TO_REFRESH = nameSpace + "_" + ACCESS_TO_REFRESH;
        REFRESH = nameSpace + "_" + REFRESH;
        REFRESH_TO_ACCESS = nameSpace + "_" + REFRESH_TO_ACCESS;
        CLIENT_ID_TO_ACCESS = nameSpace + "_" + CLIENT_ID_TO_ACCESS;
        UNAME_TO_ACCESS = nameSpace + "_" + UNAME_TO_ACCESS;
    }
